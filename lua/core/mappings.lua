...
maps.i["<C-s>"] = { "<cmd>w!<cr><esc>", desc = "Force write" }
...
if is_available "neovim-session-manager" then
  ...
  maps.n["<leader>sf"] = { "zR<cmd>SessionManager! save_current_session<cr><cmd>SessionManager! load_session<cr> ", desc = "Search sessions" }
  maps.n["<leader>S."] =
...
if is_available "toggleterm.nvim" then
  ...
  maps.n["<leader>tt"] = { function() toggle_term_cmd "<cmd>ToggleTerm size=10 direction=horizontal<cr>" end, desc = "Horizontal terminal" }
